/* ==================================================================
 * DaytimerEventBinaryFileHandlerTests.java - 20/09/2016 7:33:10 PM
 * 
...
public class DaytimerEventBinaryFileHandlerTests {
	...
	private DaytimerEventBinaryFileHandler handler;
	...
	public void supportsViaMessageType() {
		MessageHeader header = new MessageHeader(MessageType.EventTableDaytimerStates, null, 0);
	...
	public void parseEventTable() throws IOException {
		byte[] data = FileCopyUtils.copyToByteArray(
				Base64.getMimeDecoder().wrap(getClass().getResourceAsStream("daytimer-events-01.b64")));
		Assert.assertEquals("Data length", 148, data.length);
		ByteBuffer buffer = ByteBuffer.wrap(data);
		MessageHeader header = new MessageHeader(MessageType.EventTableDaytimerStates, null,
				data.length);
