/* ==================================================================
 * UUIDDeserializerTests.java - 19/09/2016 3:55:38 PM
 * 
...
public class UUIDDeserializerTests {
	...
	public void setup() throws Exception {
		...
		factory.setDeserializers(Arrays.asList(deserializer));
		objectMapper = factory.getObject();
	}

	@Test
	public void deserialize() throws IOException {
		UUID result = objectMapper.readValue("\"0e839a0b-00d8-1ab1-ffffa1b98ee6c71d\"", UUID.class);
		Assert.assertNotNull(result);
		Assert.assertEquals("0e839a0b-00d8-1ab1-ffff-a1b98ee6c71d", result.toString());
	}
