/* ==================================================================
 * DatumPropertyUUIDPatchSet.java - 4/10/2016 4:08:06 PM
 * 
 ...
 * {@link DatumPropertyUUIDEntityParameters}.
 * 
 * @author matt
 * @version 1.0
 */
public class DatumPropertyUUIDPatchSet extends UUIDPatchSet {

	private final Map<UUID, DatumPropertyUUIDEntityParameters> parameters;
	 ...
	 */
	@JsonCreator
	public DatumPropertyUUIDPatchSet(@JsonProperty(value = "add", required = false) List<UUID> add,
			@JsonProperty(value = "remove", required = false) List<UUID> remove,
			@JsonDeserialize(keyUsing = UUIDKeyDeserializer.class) @JsonProperty(value = "parameters", required = false) Map<UUID, BasicDatumPropertyUUIDEntityParameters> parameters) {
		super(add, remove);
		if ( parameters != null ) {
	...
	public Map<UUID, DatumPropertyUUIDEntityParameters> getParameters() {
		return parameters;
	}
